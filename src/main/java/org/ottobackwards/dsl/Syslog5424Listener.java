...
import org.ottobackwards.dsl.generated.Rfc5424Listener;
...
public class Syslog5424Listener implements Rfc5424Listener {
    ...
    public Syslog5424Listener(){}

    public Map<String,Object> getMsgMap() { return Collections.unmodifiableMap(msgMap);}
    ...
    public void exitHeaderPriorityValue(Rfc5424Parser.HeaderPriorityValueContext ctx) {
        msgMap.put(SyslogFieldKeys.HEADER_PRI.getField(),ctx.getText());
    }
    ...
    public void exitHeaderVersion(Rfc5424Parser.HeaderVersionContext ctx) {
        msgMap.put(SyslogFieldKeys.HEADER_VERSION.getField(),ctx.getText());
    }
    ...
    public void exitHeaderHostName(Rfc5424Parser.HeaderHostNameContext ctx) {
        msgMap.put(SyslogFieldKeys.HEADER_HOSTNAME.getField(),ctx.getText());
    ...
    public void exitHeaderAppName(Rfc5424Parser.HeaderAppNameContext ctx) {
        msgMap.put(SyslogFieldKeys.HEADER_APPNAME.getField(),ctx.getText());
    ...
    public void exitHeaderProcId(Rfc5424Parser.HeaderProcIdContext ctx) {
        msgMap.put(SyslogFieldKeys.HEADER_PROCID.getField(),ctx.getText());
    ...
    public void exitHeaderMsgId(Rfc5424Parser.HeaderMsgIdContext ctx) {
        msgMap.put(SyslogFieldKeys.HEADER_MSGID.getField(),ctx.getText());
    }
    ...
    public void exitHeaderTimeStamp(Rfc5424Parser.HeaderTimeStampContext ctx) {
        msgMap.put(SyslogFieldKeys.HEADER_TIMESTAMP.getField(),ctx.full_date().getText() +
